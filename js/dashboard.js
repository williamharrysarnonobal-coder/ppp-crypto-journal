...
const SALARY_DEFAULTS = {
  ...
  aed_per_usd: 3.6725,
  php_per_usd: 60.93,
  // How many consecutive covered months you personally count as "ready" —
  // deliberately yours to set rather than a number this page asserts.
  streak_target: 6
};
...
function _salaryStreakTarget(){
  const v = Number(_salaryInputValues().streak_target);
  return v > 0 ? Math.round(v) : 6;
}
...
const CONFLUENCE_SETUPS = {
  'Long|5 mins HL': {
    ...
    items: [
      ...
      {tag:'MACD · 3M', text:'Did 3min MACD Breakdown?', invert:true},
  ...
  'Short|5 mins LH': {
    ...
    items: [
      ...
      {tag:'MACD · 3M', text:'Did 3min MACD Breakout?', invert:true},
